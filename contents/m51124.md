...
<th data-align="left">pH Values 0.100 <em>M</em> HCl<sup data-type="footnote-number" id="footnote-ref1"><a data-type="footnote-link" href="#footnote1">1</a></sup></th>
<th data-align="left">pH Values 0.100 <em>M</em> CH<sub>3</sub>CO<sub>2</sub>H<sup data-type="footnote-number" id="footnote-ref2"><a data-type="footnote-link" href="#footnote2">2</a></sup></th>
</tr>
</thead><tbody>
<tr valign="top">
...
(c) In (b), 25.00 mL of the NaOH solution was added, and so practically all the CH<sub>3</sub>CO<sub>2</sub>H was converted into <math xmlns="http://www.w3.org/1998/Math/MathML"><mrow><msub><mrow><mtext>CH</mtext></mrow><mn>3</mn></msub><msub><mrow><mtext>CO</mtext></mrow><mn>2</mn></msub><msup><mrow /><mtext>−</mtext></msup><mo>.</mo></mrow></math>
...
Color change pH intervals for three different acid-base indicators are shown in [\[link\]](#CNX_Chem_14_07_titration2). Since the phenolphthalein color change interval occurs within the near-vertical portions of both titrations curves, this indicator may be used to signal the end point in both strong and weak acid titrations.
...
<div data-type="exercise">
<div data-type="problem" markdown="1">
Why can we ignore the contribution of water to the concentration of OH<sup>−</sup> in a solution of the following bases:
...
* {: data-type="footnote-ref" #footnote1} [1](#footnote-ref1){: data-type="footnote-ref-link"} <span data-type="footnote-ref-content">Titration of 25.00 mL of 0.100 *M* HCl (0.00250 mol of HCI) with 0.100 *M* NaOH.</span>
* {: data-type="footnote-ref" #footnote2} [2](#footnote-ref2){: data-type="footnote-ref-link"} <span data-type="footnote-ref-content">Titration of 25.00 mL of 0.100 *M* CH<sub>3</sub>CO<sub>2</sub>H (0.00250 mol of CH<sub>3</sub>CO<sub>2</sub>H) with 0.100 *M* NaOH.</span>
