...
<div data-type="solution" markdown="1">
[CO] = 2.04 <math xmlns="http://www.w3.org/1998/Math/MathML"><mo>×</mo></math>
...
{: data-type="newline"}
 ...
 (b) [CO<sub>2</sub>] = 0.50 *M* Added H<sub>2</sub> forms some water to compensate for the removal of water vapor and as a result of a shift to the left after H<sub>2</sub> is added.
