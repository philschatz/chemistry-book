...
<span data-type="title">Solution: Using the Equation</span>Use the special form of Hess’s law given previously, and values from [Appendix G](/m51221){: .target-chapter}\:
...
<div data-type="exercise">
<div data-type="problem" markdown="1">
Calculate the enthalpy of solution (Δ*H* for the dissolution) per mole of CaCl<sub>2</sub> (refer to exercise 25).
...
* {: data-type="footnote-ref" #footnote1} [1](#footnote-ref1){: data-type="footnote-ref-link"} <span data-type="footnote-ref-content">For more on algal fuel, see http://www.theguardian.com/environment/2010/feb/13/algae-solve-pentagon-fuel-problem.</span>
