...
<div data-type="media" data-alt="Three structures are shown, each with a red, central N atom which has a pair of electron dots indicated in red above the N atoms. The first structure is labeled methyl amine. To the left of the N, a C H subscript 3 group is bonded. H atoms are bonded to the right and bottom of the central N atom. The second structure is labeled dimethyl amine. This structure has C H subscript 3 groups bonded to the left and right of the N atom and a single H atom is bonded below. The third structure is labeled trimethyl amine, which has C H subscript 3 groups bonded to the left, right, and below the central N atom.">
![Three structures are shown, each with a red, central N atom which has a pair of electron dots indicated in red above the N atoms. The first structure is labeled methyl amine. To the left of the N, a C H subscript 3 group is bonded. H atoms are bonded to the right and bottom of the central N atom. The second structure is labeled dimethyl amine. This structure has C H subscript 3 groups bonded to the left and right of the N atom and a single H atom is bonded below. The third structure is labeled trimethyl amine, which has C H subscript 3 groups bonded to the left, right, and below the central N atom.](../resources/CNX_Chem_20_04_amines_img.jpg)
</div>

In some amines, the nitrogen atom replaces a carbon atom in an aromatic hydrocarbon. Pyridine ([\[link\]](#CNX_Chem_20_04_pyridine_img)) is one such heterocyclic amine. A heterocyclic compound contains atoms of two or more different elements in its ring structure.
...
<div data-type="solution" markdown="1">
CH<sub>3</sub><u>C</u>H = <u>C</u>HCH<sub>3</sub>(*sp*<sup>2</sup>) + Cl <math xmlns="http://www.w3.org/1998/Math/MathML"><mo stretchy="false">⟶</mo></math>

 CH<sub>3</sub><u>C</u>H(Cl)H(Cl)CH<sub>3</sub>(*sp*<sup>3</sup>); * * *
{: data-type="newline"}

 2<u>C</u><sub>6</sub>H<sub>6</sub>(*sp*<sup>2</sup>) + 15O<sub>2</sub> <math xmlns="http://www.w3.org/1998/Math/MathML"><mo stretchy="false">⟶</mo></math>

 12<u>C</u>O<sub>2</sub>(*sp*) + 6H<sub>2</sub>O
