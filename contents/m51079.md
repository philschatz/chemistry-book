...
<div data-type="exercise">
<div data-type="problem" markdown="1">
Explain why the molar enthalpies of vaporization of the following substances increase in the order CH<sub>4</sub> &lt; C<sub>2</sub>H<sub>6</sub> &lt; C<sub>3</sub>H<sub>8</sub>, even though all three substances experience the same dispersion forces when in the liquid state.
