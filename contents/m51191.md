...
1.  [1](#footnote-ref1){: data-type="footnote-ref" name="footnote1"} This is the Beilstein database, now available through the Reaxys site (www.elsevier.com/online-tools/reaxys).
2.  [2](#footnote-ref2){: data-type="footnote-ref" name="footnote2"} Peplow, Mark. “Organic Synthesis: The Robo-Chemist,” *Nature* 512 (2014): 20–2.
3.  [3](#footnote-ref3){: data-type="footnote-ref" name="footnote3"} Physical properties for C<sub>4</sub>H<sub>10</sub> and heavier molecules are those of the *normal isomer*, *n*-butane, *n*-pentane, etc.
4.  [4](#footnote-ref4){: data-type="footnote-ref" name="footnote4"} STP indicates a temperature of 0 °C and a pressure of 1 atm.
