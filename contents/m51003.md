...
Click on this [link][1] for an interactive periodic table, which you can use to explore the properties of the elements (includes podcasts and videos of each element). You may also want to try this [one](openstax.org/l/16Periodic2) that shows photos of all the elements.
...
[1]: http://openstax.org/l/16Periodic
